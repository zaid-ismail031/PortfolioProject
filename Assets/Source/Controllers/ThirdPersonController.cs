...
namespace StarterAssets
{
  ...
  {
    [Header( "Combat" )]
    [Tooltip( "How far the punch can reach" )]
    public float PunchRange = 2.0f;
    [Tooltip( "Angle in degrees for the punch cone" )]
    public float PunchAngle = 60.0f;
    ...
    private void AssignAnimationIDs()
    {
      ...
      _animIDCower = Animator.StringToHash( "Cower" );
    }
    ...
    private void Punch()
    {
      if( _input.punch && !_input.aim && Grounded && _hasAnimator )
      {
    ...
    private void Cower()
    {
      if( _hasAnimator )
      {
        _animator.SetBool( _animIDCower, _input.cower );
      }
    }
    ...
    public void ToggleRotateOnMove( bool toggle )
    {
      _rotateOnMove = toggle;
    }
